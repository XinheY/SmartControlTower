...
// 获取显示指定分组的视图
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (maplistInCliExp.size() != 0) {
            if (maplistInCliExp.get(groupPosition)!=null) {
                Log.e("mapss是",maplistInCliExp.get(groupPosition).size()+"");
...
//设置数据
     ...
     */
    public void inputdata(ArrayList<List<Object>> maplist, int leftIndicator, int rightIndicator, int groupbyCount, String submitVersionTitle, String compareVersionTitle) {
