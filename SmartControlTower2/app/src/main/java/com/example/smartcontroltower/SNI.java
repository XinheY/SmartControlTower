...
public class SNI extends AppCompatActivity {
...
////////////////////////////////////////////left side///////////////////////////////////////////
        ...
        nv.setCheckedItem(R.id.nav_SNI);
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.nav_E2E:
                        Intent intent2=new Intent(SNI.this,E2E.class);
                        startActivity(intent2);
                        finish();
                        break;
                    case R.id.nav_MFG:
                        Intent intent4=new Intent(SNI.this,MFG.class);
                    ...
                    case R.id.nav_analysis:
                        Intent intent3=new Intent(SNI.this,Analysis.class);
